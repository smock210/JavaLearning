...
public class WorkWithExceptions
{
     ...
     */
    public void exceptionProcessing() throws MyCustomException {
        try {
            ...
            // Вызов кастомного исключения
            throw new MyCustomException("Выпало исключение", e);
        } finally {
            // Блок finally
